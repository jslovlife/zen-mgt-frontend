...
export default function PaymentPlatform() {
  const moduleData = ModuleMetadata['payment-platform'];
  ...
  return (
    <div className="module-container">
      ...
      <div className="empty-state">
        ...
        <h3 className="empty-state-title">No Payment Platforms</h3>
        <p className="empty-state-description">
          Get started by adding your first payment platform integration.
        </p>
        <Button variant="primary" size="md">
          {moduleData.addButtonText}
        </Button>
